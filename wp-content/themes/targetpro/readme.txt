...
The Target theme uses CUSTOM POST TYPE. In the wordpress admin, on the left side you will see a "SLIDES" POST type. Please ADD your SLIDES here. Don't forget to upload your image in the extra option field given Slider image of exact size 963px x 350px. 
...
Thanks for downloading the target theme.
